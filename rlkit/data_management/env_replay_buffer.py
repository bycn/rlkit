...
# Don't need this, old code
# class VecEnvReplayBuffer(SimpleReplayBuffer):
#     def __init__(
#             self,
#             max_replay_buffer_size,
#             env,
#             n_envs, #Added this. number of parallel environments
#             env_info_sizes=None
#     ):
#         """
#         :param max_replay_buffer_size:
...
#         self.env = env
#         self.n_envs = n_envs
#         self._ob_space = env.envs[0].observation_space
#         self._action_space = env.envs[0].action_space
...
# !!! This code should NOT be used, experimental.
